...
echo "// DO NOT EDIT. This was generated by gen.sh" > src/hal/cpu/gen_cpu.rs

echo "#![allow(unused)]" >> src/hal/cpu/gen_cpu.rs
echo "#![allow(non_snake_case)]" >> src/hal/cpu/gen_cpu.rs
echo "#![allow(non_upper_case_globals)]" >> src/hal/cpu/gen_cpu.rs
